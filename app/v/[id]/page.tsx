...
const jsonLd = {
        ...
        interactionStatistic: {
            ...
            interactionType: {
                '@type': `WatchAction`,
                target: `https://bokepbocah.pages.dev/v/${file.filecode}`
            }  
        }
        }
        const jsonLd2 = {
